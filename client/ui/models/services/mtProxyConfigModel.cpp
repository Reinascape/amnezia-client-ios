...
bool MtProxyConfigModel::setData(const QModelIndex &index, const QVariant &value, int role)
{
    ...
    case Roles::IsEnabledRole: m_protocolConfig.insert(protocols::mtProxy::isEnabledKey, value.toBool()); break;
    case Roles::PublicHostRole: m_protocolConfig.insert(protocols::mtProxy::publicHostKey, value.toString()); break;
    case Roles::TransportModeRole:
        m_protocolConfig.insert(protocols::mtProxy::transportModeKey, value.toString());
        break;
    case Roles::TlsDomainRole: m_protocolConfig.insert(protocols::mtProxy::tlsDomainKey, value.toString()); break;
    case Roles::AdditionalSecretsRole:
        ...
        break;
    case Roles::WorkersModeRole: m_protocolConfig.insert(protocols::mtProxy::workersModeKey, value.toString()); break;
    case Roles::WorkersRole: m_protocolConfig.insert(protocols::mtProxy::workersKey, value.toString()); break;
    case Roles::NatEnabledRole: m_protocolConfig.insert(protocols::mtProxy::natEnabledKey, value.toBool()); break;
...
QVariant MtProxyConfigModel::data(const QModelIndex &index, int role) const
{
    ...
    case Roles::IsEnabledRole: return m_protocolConfig.value(protocols::mtProxy::isEnabledKey).toBool(true);
    ...
    case Roles::TlsDomainRole: return m_protocolConfig.value(protocols::mtProxy::tlsDomainKey).toString();
    case Roles::AdditionalSecretsRole: {
    ...
    case Roles::NatEnabledRole: return m_protocolConfig.value(protocols::mtProxy::natEnabledKey).toBool(false);
    case Roles::NatInternalIpRole: return m_protocolConfig.value(protocols::mtProxy::natInternalIpKey).toString();
    case Roles::NatExternalIpRole: return m_protocolConfig.value(protocols::mtProxy::natExternalIpKey).toString();
    }
